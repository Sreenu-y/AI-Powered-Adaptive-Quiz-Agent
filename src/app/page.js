      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12">
            Supercharge Your Learning with Quiz Agent
          </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-muted-foreground">Topics Supported</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-semibold">99%</h3>
              <p className="text-muted-foreground">Accuracy Rate</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-semibold">24/7</h3>
              <p className="text-muted-foreground">AI Experts</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Four simple steps to master any subject with ease
            </p>
          </div>
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              Join thousands of learners who are mastering complex topics with
